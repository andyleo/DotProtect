...
namespace DotProtect.Protections.AntiTamper {
	internal class JITMode : IModeHandler {
		...
		public void HandleInject(AntiTamperProtection parent, DotProtectContext context, ProtectionParameters parameters) {
			...
			TypeDef initType = rt.GetRuntimeType("DotProtect.Runtime.AntiTamperJIT");
		...
		public void HandleMD(AntiTamperProtection parent, DotProtectContext context, ProtectionParameters parameters) {
