			...
			void OnWriterEvent(object sender, ModuleWriterListenerEventArgs e) {
				...
				if (e.WriterEvent == ModuleWriterEvent.MDEndCreateTables) {
					...
					*/
					...
					/*
					We are going to create a new specific '#GUID' Heap to avoid UnDotProtect to work.
					<sarcasm>UnDotProtect is so well coded, it relies on static cmp between values</sarcasm>
