...
namespace DotProtect.Core {
	/// <summary>
	///     Parameters that passed to <see cref="DotProtectEngine" />.
	/// </summary>
	public class DotProtectParameters {
		/// <summary>
		///     Gets or sets the project that would be processed.
		/// </summary>
		/// <value>The DotProtect project.</value>
		public DotProtectProject Project { get; set; }
