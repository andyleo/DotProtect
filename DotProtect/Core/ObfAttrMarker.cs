...
namespace DotProtect.Core {
	...
	public class ObfAttrMarker : Marker {
		...
		class ProtectionSettingsStack {
			...
			public ProtectionSettingsStack(DotProtectContext context, Dictionary<string, Protection> protections) {
		...
		DotProtectContext context;
		DotProtectProject project;
		Packer packer;
		...
		/// <inheritdoc />
		protected internal override void MarkMember(IDnlibDef member, DotProtectContext context) {
