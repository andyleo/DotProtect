...
namespace DotProtect.Core.Project
{
    /// <summary>
    ///     A module description in a DotProtect project.
    /// </summary>
    public class ProjectModule
    {
        ...
        {
            XmlElement elem = xmlDoc.CreateElement("module", DotProtectProject.Namespace);
    ...
    /// <summary>
    ///     A <see cref="DotProtectComponent" /> setting within a rule.
    /// </summary>
    ...
    public class SettingItem<T> : Dictionary<string, string>
    {
        ...
        /// <seealso cref="DotProtectComponent.Id" />
        ...
        internal XmlElement Save(XmlDocument xmlDoc)
        {
            XmlElement elem = xmlDoc.CreateElement(typeof(T) == typeof(Packer) ? "packer" : "protection", DotProtectProject.Namespace);
            ...
            {
                XmlElement arg = xmlDoc.CreateElement("argument", DotProtectProject.Namespace);
    ...
    public class Rule : List<SettingItem<Protection>>
    {
        ...
        internal XmlElement Save(XmlDocument xmlDoc)
        {
            XmlElement elem = xmlDoc.CreateElement("rule", DotProtectProject.Namespace);
    ...
    /// <summary>
    ///     Represent a project of DotProtect.
    /// </summary>
    public class DotProtectProject : List<ProjectModule>
    {
        /// <summary>
        ///     The namespace of DotProtect project schema
        /// </summary>
        public const string Namespace = "http://DotProtect.codeplex.com";

        /// <summary>
        ///     The schema of project XML.
        /// </summary>
        public static readonly XmlSchema Schema = XmlSchema.Read(new StringReader(Properties.Resources.DotProtectPrj), null);

        /// <summary>
        ///     Initializes a new instance of the <see cref="DotProtectProject" /> class.
        /// </summary>
        public DotProtectProject()
        {
        ...
        /// <exception cref="DotProtect.Core.Project.ProjectValidationException">
        ...
        public DotProtectProject Clone()
        {
            var ret = new DotProtectProject();
            ret.Seed = Seed;
            ret.Debug = Debug;
